...
public class CameraController : MonoBehaviour
{
    ...
    void MoveCamera(bool smooth)
    {
        ...
        if (smooth) this.transform.position = Vector3.SmoothDamp(this.transform.position, destination, ref velocity, delayTime);
        else this.transform.position = destination;
    }
